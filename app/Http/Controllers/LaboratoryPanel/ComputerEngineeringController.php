...
class ComputerEngineeringController extends Controller
{
    ...
    {
        return view('laboratory.computer_engineering.create');
    }
    ...
    public function printAll(Request $request)
    {
        ...
        $computerEngineering = ComputerEngineering::paginate($perPage, ['*'], 'page', $page);

        return view('laboratory.computer_engineering.print', compact('computerEngineering'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('laboratory-computer-engineering.index')->with('message', 'Successfully updated!');
    }
    ...
    {
        ComputerEngineering::whereIn('id', request('ids'))->delete();
