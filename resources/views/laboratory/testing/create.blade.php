    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-success ">Add Testing and Mechanics Equipment</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h1 class="card-title">Testing & Mechanics</h1>
                </div>
                <div class="card-body">
                    <form action="{{ route('testings.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
