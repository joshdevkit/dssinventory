                                        ...
                                        @forelse($fluids as $fluid)
                                            <tr data-entry-id="{{ $fluid->id }}">
                                                ...
                                                <div class="btn-group btn-group-sm" role="group"
                                                        ...
                                                        &nbsp
                                                        <form action="{{ route('fluids.destroy', $fluid->id) }}"
...
@section('scripts')
    <script>
        document.getElementById('print-btn').addEventListener('click', function() {
            ...
            <html>
            <head>
                <title>Print HYDROLICS AND FLUIDS Data</title>
            <style>
                @media print {
                    @page {
                        size: landscape;
            ...
            <body>
                ...
                <div class="school-title">
                    ...
                    <h5><strong>INVENTORY OF HYDROLICS AND FLUIDS</strong></h5>
                </div>
                ${dataTable.outerHTML}
            </body>
            </html>
